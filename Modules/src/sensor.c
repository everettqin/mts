...
__IO uint16_t SENSOR_A_ConvertedValue = 0;
__IO uint16_t SENSOR_B_ConvertedValue = 0;
...
void SENSOR_DMA_Init(void) {
  ...
  DMA_InitStructure.DMA_Memory0BaseAddr = (uint32_t)&SENSOR_A_ConvertedValue;
...
void SENSOR_ADC_Init(void) {
  ...
  //ADC_RegularChannelConfig(ADC2, ADC_Channel_13, 2, ADC_SampleTime_144Cycles);
